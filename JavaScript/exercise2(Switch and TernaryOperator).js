...
//Answer 1 -> var experiencePoints = winBattle() ? 10 : 1;
...
function switchPractice(caseCheck){
    switch(caseCheck){
        case "Monday" : return "Boring Day";
        break;
        case "Tuesday": return "Utter Boring Day";
        case 3: return "This is a number";
        default: return "End of program." 
    }
}
